...
- Do not run 'dx serve' or any 'dx' commands. Instead run only 'cargo check' and prompt the user for manual check and serve.
- If user does NOT EXPLICITLY tell you to do something, do NOTHING and ONLY chat with the user. Do NOT run any commands or modify files before user's explicit permission.
- Do absolutely nothing for the user! The user is the one who does everything. Your job is to guide the user and help them with their tasks step by step!
